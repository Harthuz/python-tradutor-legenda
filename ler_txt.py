...
with open("Living Single - S01 E01 - Judging by the Cover (480p - HULU Web-DL).srt", 'r', encoding='utf-8-sig') as f:
    texto = f.readlines()
...
with open("legenda_traduzida.srt", 'w', encoding='utf-8-sig') as f:
